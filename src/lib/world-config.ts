...
export const DEFAULT_WORLD_CONFIG: WorldConfig = {
  ...
  obstacles: DEFAULT_OBSTACLE_CONFIG,
};
export function mergeWorldConfig(config: Partial<WorldConfig> = {}): WorldConfig {
  return {
    ...DEFAULT_WORLD_CONFIG,
    ...config,
    terrain: { ...DEFAULT_TERRAIN_CONFIG, ...config.terrain },
    rivers: { ...DEFAULT_RIVER_CONFIG, ...config.rivers },
    obstacles: { ...DEFAULT_OBSTACLE_CONFIG, ...config.obstacles },
  };
}
